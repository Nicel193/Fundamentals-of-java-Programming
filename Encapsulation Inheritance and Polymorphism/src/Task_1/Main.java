...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        PsychologistWithArray psychologist = new PsychologistWithArray("Dmitrievna", 5);
        ...
        PsychologistWithSorting psychologistWithSorting = new PsychologistWithSorting("Oleg", 10);
